...
mock_sanctions = {
    "P-101": {
        ...
        "path": {
            ...
            "path_nodes": [
                ...
                {"id": "SANCT-EU-CFSP", "name": "EU Consolidated Sanctions", "label": "SanctionList", "risk_score": 1.0, "country": "EU"}
            ],
            "path_relationships": [
    ...
    "P-106": {
        ...
        "path": {
            ...
            "path_nodes": [
                {"id": "P-106", "name": "Sergei Volkov", "label": "Person", "risk_score": 0.99, "country": "Russian"},
                {"id": "SANCT-OFAC-SDN", "name": "OFAC SDN List", "label": "SanctionList", "risk_score": 1.0, "country": "United States"}
            ],
            "path_relationships": [
                {"type": "SANCTIONED_UNDER", "from_id": "P-106", "to_id": "SANCT-OFAC-SDN", "properties": {"listed_date": "2022-04-15"}}
            ]
        }
    },
    "C-201": {
        ...
        "path": {
            ...
            "path_nodes": [
                {"id": "C-201", "name": "Seashell Global Holdings Ltd", "label": "Company", "risk_score": 0.91, "country": "BVI"},
                {"id": "P-101", "name": "Viktor Sterling", "label": "Person", "risk_score": 0.94, "country": "Russian"},
                {"id": "SANCT-EU-CFSP", "name": "EU Consolidated Sanctions", "label": "SanctionList", "risk_score": 1.0, "country": "EU"}
            ],
            "path_relationships": [
                {"type": "OWNS", "from_id": "P-101", "to_id": "C-201", "properties": {"share_pct": 100.0}},
                {"type": "SANCTIONED_UNDER", "from_id": "P-101", "to_id": "SANCT-EU-CFSP", "properties": {"listed_date": "2022-05-10"}}
            ]
        }
    },
    "ACC-9005": {
        ...
        "path": {
            ...
            "path_nodes": [
                {"id": "ACC-9005", "name": "AE07-Dubai-Mashreq", "label": "BankAccount", "risk_score": 0.85, "country": "UAE"},
                {"id": "ACC-9007", "name": "RU40-Moscow-Sber", "label": "BankAccount", "risk_score": 0.95, "country": "Russia"},
    ...
    "ACC-9009": {
        ...
        "path": {
            ...
            "path_nodes": [
                {"id": "ACC-9009", "name": "US12-JPMorgan-NYC", "label": "BankAccount", "risk_score": 0.48, "country": "United States"},
                {"id": "ACC-9004", "name": "GB29-London-Metro", "label": "BankAccount", "risk_score": 0.62, "country": "United Kingdom"},
                {"id": "ACC-9005", "name": "AE07-Dubai-Mashreq", "label": "BankAccount", "risk_score": 0.85, "country": "UAE"},
                {"id": "ACC-9007", "name": "RU40-Moscow-Sber", "label": "BankAccount", "risk_score": 0.95, "country": "Russia"},
                {"id": "C-205", "name": "Vostok Precision Dynamics", "label": "Company", "risk_score": 0.99, "country": "Russia"},
                {"id": "SANCT-OFAC-SDN", "name": "OFAC SDN List", "label": "SanctionList", "risk_score": 1.0, "country": "United States"}
...
# Write standalone app.js content using token replacement
data_prefix = (
    "// ==========================================\n"
    "// EMBEDDED REALISTIC DATASET (CLIENT-SIDE RESILIENCE)\n"
    "// ==========================================\n"
    f"const DEFAULT_NODES = {json.dumps(mock_nodes, indent=2)};\n"
    f"const DEFAULT_EDGES = {json.dumps(mock_edges, indent=2)};\n"
    f"const DEFAULT_RINGS = {json.dumps(mock_rings, indent=2)};\n"
    f"const DEFAULT_UBO = {json.dumps(mock_ubo, indent=2)};\n"
    f"const DEFAULT_SANCTIONS = {json.dumps(mock_sanctions, indent=2)};\n"
    f"const DEFAULT_MULE_HUBS = {json.dumps(mock_mules, indent=2)};\n\n"
)

js_body = """// Resilient fast fetch with timeout
...
full_app_js = data_prefix + js_body

# Copy app.js across all paths
...
print("SUCCESS: All 4 modules (UBO, Sanctions, Mules, Cypher Playground) updated and fully synchronized!")
